...
We introduce distance measures between trees with 'related' tip labels in a recently submitted paper, "Comparing trees according to tip label categories", soon to be available on bioRxiv.
